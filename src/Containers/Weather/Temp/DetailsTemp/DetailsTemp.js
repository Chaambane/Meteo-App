    ...
    <div className="container temp w-50 detailsTemp rounded">
        <div className="container d-flex mt-4">
            ...
            <div className="col-6 row">
                <p>Vent: <span className="fs-4 col-sm">{props.wind.speed} Km/h</span></p>
                <p>Humidité: <span className="fs-4 col-sm">{props.main.humidity}</span></p>
                <p>Pression: <span className="fs-4 col-sm">{props.main.pressure} Pa</span></p>
            </div>
        </div>
    </div>
);
